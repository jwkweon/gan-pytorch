...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', type=str, default='cifar10', help='dataset name: ["cifar10"]')
    parser.add_argument('--n_batch', type=int, help='number of batch', default=1024)
    parser.add_argument('--n_epochs', type=int, help='epochs to train', default=1000)
    parser.add_argument('--n_samples', type=int, default=36)
    parser.add_argument('--z_dim', type=int, help='number of worker processes', default=100)
